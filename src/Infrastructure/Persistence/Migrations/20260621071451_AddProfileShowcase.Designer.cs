...
namespace OsuStocks.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260621071451_AddProfileShowcase")]
    partial class AddProfileShowcase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OsuStocks.Domain.Entities.DailyLoginReward", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "RewardDate")
                        .IsUnique()
                        .HasDatabaseName("uq_daily_login_rewards_user_date");

                    b.ToTable("daily_login_rewards", (string)null);
                });
            ...
            modelBuilder.Entity("OsuStocks.Domain.Entities.MarketSettings", b =>
                {
                    ...
                    b.Property<decimal>("TradeFeeMultiplier")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(10,4)")
                        .HasDefaultValue(1m)
                        .HasColumnName("trade_fee_multiplier");
            ...
            modelBuilder.Entity("OsuStocks.Domain.Entities.TrackedPlayer", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastInactivityDecayAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_inactivity_decay_at");
                    ...
                    b.Property<string>("ProfileCoverUrl")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("profile_cover_url");
            ...
            modelBuilder.Entity("OsuStocks.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int>("DailyRewardStreak")
                        ...
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("daily_reward_streak");

                    b.Property<string>("EquippedTitleCode")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("equipped_title_code");

                    b.Property<DateOnly?>("LastDailyRewardDate")
                        .HasColumnType("date")
                        .HasColumnName("last_daily_reward_date");
                    ...
                    b.PrimitiveCollection<List<string>>("ShowcasedAchievementCodes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
